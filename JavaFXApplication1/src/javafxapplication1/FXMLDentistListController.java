...
public class FXMLDentistListController implements Initializable {
    ...
    @FXML private TableColumn<ModelTable,String> col_speciality;
    
    @FXML private ObservableList<ModelTable1> oblist = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ResultSet rs = con.createStatement().executeQuery("select * from dentist");

        while(rs.next()){
            oblist.add(new ModelTable1(rs.getString("dentistid"),rs.getString("dentistname"),rs.getString("dentistage"),rs.getString("dentistgender"),rs.getString("dentistaddress"),rs.getString("dentistphone"),rs.getString("dentistbloodgroup"),rs.getString("dentistspeciality")));
        }
        }
        catch(Exception e){
            e.printStackTrace();
